...
class StorageQuotaWarningSpec(
    ...
    push_body: ClassVar[str] = (
        ...
        "до окончания льготного периода, иначе часть файлов будет "
        "удалена — включая медиа в уже опубликованных конспектах."
    )
    email_subject: ClassVar[str] = "Файлы Learnic превышают тариф"
    email_body: ClassVar[str] = (
        "Суммарный размер файлов в ваших конспектах превысил лимит "
        "тарифа. По истечении льготного периода лишние файлы будут "
        "удалены автоматически — это затронет и медиа в уже "
        "опубликованных конспектах (на их месте останется заглушка). "
        "Чтобы этого избежать, освободите место или повысьте план "
