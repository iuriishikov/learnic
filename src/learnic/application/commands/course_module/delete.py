...
class DeleteCourseModuleCommand:
    actor_id: UserID
    module_id: CourseModuleID


@final
class DeleteCourseModuleCommandHandler:
    """Hard-delete a module. Cascades to lessons (and later blocks)."""
    ...
    async def run(self, data: DeleteCourseModuleCommand) -> None:
