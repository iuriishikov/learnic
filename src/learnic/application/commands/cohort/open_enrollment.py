...
class OpenCohortEnrollmentCommand:
    actor_id: UserID
    cohort_id: CohortID


@final
class OpenCohortEnrollmentCommandHandler:
    def __init__(
        self,
    ...
    async def run(self, data: OpenCohortEnrollmentCommand) -> None:
