...
from learnic.entities.cohort.value_objects import RecordingUrl
from learnic.entities.user.models import UserID


@dataclass(slots=True, frozen=True)
class AttachWebinarSessionRecordingCommand:
    actor_id: UserID
...
@final
class AttachWebinarSessionRecordingCommandHandler:
    def __init__(
        self,
    ...
    async def run(
        self,
        data: AttachWebinarSessionRecordingCommand,
    ) -> None:
        ...
        session.attach_recording(RecordingUrl(data.url))
