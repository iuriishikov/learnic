...
class RescheduleWebinarSessionCommand:
    actor_id: UserID
...
@final
class RescheduleWebinarSessionCommandHandler:
    def __init__(
        self,
    ...
    async def run(
        self,
        data: RescheduleWebinarSessionCommand,
    ) -> None:
        ...
        session.reschedule(data.starts_at)
