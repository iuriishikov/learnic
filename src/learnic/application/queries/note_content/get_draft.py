...
class GetNoteDraftQuery:
    actor_id: UserID
    product_id: ProductID


@final
class GetNoteDraftQueryHandler:
    """Return the full draft tree of a note.
    ...
    def __init__(
        ...
        content_reader: NoteContentReader,
    ) -> None:
        self._authorizer: Final = authorizer
        self._product_gateway: Final = product_gateway
        self._content_reader: Final = content_reader

    async def run(self, data: GetNoteDraftQuery) -> NoteDraftView:
